      ...
      <ScrollView className="flex-1 px-5" showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        <View className="bg-[#181920] rounded-[32px] p-6 mb-8 border border-white/5 font-sans">
          ...
          <View className="flex-row items-baseline mb-3">
            <Text className="text-white text-4xl font-extrabold tracking-tight">$1,250.00</Text>
            <Text className="text-gray-400 text-xs font-semibold ml-2">USD</Text>
          </View>
        ...
        <View className="bg-[#121212] rounded-[32px] overflow-hidden mt-4 pb-2 border border-white/5">
          ...
          <View className="p-6">
            ...
            <Text className="text-white text-xl font-bold mb-3 tracking-tight">Loft Prime - Torre{'\n'}Aurora</Text>
            ...
            <View className="flex-row space-x-3">
              <View className="bg-white/5 px-4 py-2 rounded-full">
                <Text className="text-gray-300 text-[10px] font-medium">Piso 14, Unidad 1402</Text>
              </View>
              <View className="bg-white/5 px-4 py-2 rounded-full">
                <Text className="text-gray-300 text-[10px] font-medium">Parking #B12</Text>
              </View>
            </View>
          </View>
        </View>
      ...
      */}
      <View className="absolute bottom-0 left-0 right-0 bg-[#0F0F0F] pt-4 pb-6 px-4 flex-row justify-between items-center border-t border-white/5">
        ...
        <TouchableOpacity className="items-center flex-1 opacity-50">
          ...
          <Text className="text-white text-[10px] font-medium">Contracts</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity className="items-center flex-1 opacity-50">
          ...
          <Text className="text-white text-[10px] font-medium">Support</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
